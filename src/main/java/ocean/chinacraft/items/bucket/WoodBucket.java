package ocean.chinacraft.items.bucket;
...
public class WoodBucket extends BucketItem {
    ...
    public WoodBucket(Fluid fluid, Settings settings) {
        super(fluid, settings.group(Chinacraft.ITEM_GROUP));
        this.fluid = fluid;
    }

    public static ItemStack getEmptiedStack(ItemStack stack, PlayerEntity player) {
        return !player.getAbilities().creativeMode ? new ItemStack(ItemRegister.WOOD_BUCKET) : stack;
    }
        ...
        if (blockHitResult.getType() == HitResult.Type.MISS) {
            ...
            if (world.canPlayerModifyAt(user, blockPos) && user.canPlaceOn(blockPos2, direction, itemStack)) {
                ...
                if (this.fluid == Fluids.EMPTY) {
                    ...
                    if (blockState.getBlock() instanceof FluidDrainable && blockState.getBlock().equals(Blocks.WATER)) {
                        FluidDrainable fluidDrainable = (FluidDrainable)blockState.getBlock();
                        ItemStack itemStack2 = tryDrainFluid(world, blockPos, blockState);
    ...
    public ItemStack tryDrainFluid(WorldAccess world, BlockPos pos, BlockState state) {
        if ((Integer)state.get(LEVEL) == 0) {
            ...
            return new ItemStack(ItemRegister.WOOD_WATER_BUCKET);
        } else {
