...
public class CopperPowderRecipe extends SpecialCraftingRecipe {
    int hammerSlot;

    public CopperPowderRecipe(Identifier id) {
        super(id);
    }
    ...
    public boolean matches(CraftingInventory inventory, World world) {
        ...
        for (int i =0;i<inventory.size();i++){
            ...
            if (!stack.isEmpty()){
                ...
                }else if (TagHelper.Items.checkByIStack(stack,TagsRegister.Items.C_COPPER_INGOTS)){
                    stackArrayList.add(stack);
                }
            }
    ...
    public ItemStack craft(CraftingInventory inventory) {
        ...
        for (int i =0;i<inventory.size();i++){
            ...
            if (!stack.isEmpty()){
                count++;
                if (TagHelper.Items.checkByIStack(stack,TagsRegister.Items.C_COPPER_INGOTS)){
                    hasIngot = true;
    ...
    public RecipeSerializer<?> getSerializer() {
        return RecipeRegister.COPPER_DUST_RECIPE_RECIPE_SERIALIZER;
    }
}
