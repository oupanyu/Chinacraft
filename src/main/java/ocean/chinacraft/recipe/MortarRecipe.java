...
public class MortarRecipe implements Recipe<SimpleInventory> {
    ...
    public MortarRecipe(Identifier id,ItemStack output,DefaultedList<Ingredient> recipeItems){
        this.id = id;
        this.output = output;
    ...
    public static class Serializer implements RecipeSerializer<MortarRecipe>{
        ...
        public MortarRecipe read(Identifier id, JsonObject json) {
            ...
            inputs.set(0,Ingredient.fromJson(JsonHelper.getObject(json,"ingredients")));
            return new MortarRecipe(id,output,inputs);
        }
