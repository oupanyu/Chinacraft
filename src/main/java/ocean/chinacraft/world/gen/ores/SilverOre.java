...
public class SilverOre {
    private static ConfiguredFeature<?, ?> OVERWORLD_SILVER_ORE_CONFIGURED_FEATURE = new ConfiguredFeature
            (Feature.ORE, new OreFeatureConfig(
                    ...
                    BlockRegister.SILVER_ORE.getDefaultState(),
                    9)); // vein size
    ...
    public static void register(){
        Registry.register(BuiltinRegistries.CONFIGURED_FEATURE,
                new Identifier(Chinacraft.MODID, "overworld_silver_ore"), OVERWORLD_SILVER_ORE_CONFIGURED_FEATURE);
        Registry.register(BuiltinRegistries.PLACED_FEATURE, new Identifier(Chinacraft.MODID, "overworld_silver_ore"),
                OVERWORLD_SILVER_ORE_PLACED_FEATURE);
        BiomeModifications.addFeature(BiomeSelectors.foundInOverworld(), GenerationStep.Feature.UNDERGROUND_ORES,
                RegistryKey.of(Registry.PLACED_FEATURE_KEY,
                        new Identifier(Chinacraft.MODID, "overworld_silver_ore")));
    }
}
